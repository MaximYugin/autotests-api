...
def assert_create_course_response(request: CreateCourseRequestSchema, response: CreateCourseResponseSchema):
    ...
    assert_equal(request.preview_file_id, response.course.preview_file_id, "preview_file_id")
    assert_equal(request.created_by_user_id, response.course.created_by_user_id, "created_by_user_id")