...
- Measuring API test coverage automatically and watching report in artefacts — using the swagger-coverage-tool for CI.
- Reviewing pull requests from CI using AI-Review.
...
```bash
git clone https://github.com/MaximYugin/autotests-api.git
cd autotests-api
```

### Create a Virtual Environment

It's recommended to use a virtual environment to manage project dependencies. If you are using pycharm that doing auto. Follow the instructions for your operating
system:
